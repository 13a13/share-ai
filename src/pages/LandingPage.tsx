        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#features" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Features</a></li>
                <li><a href="#pricing" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Pricing</a></li>
                <li><a href="#testimonials" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Testimonials</a></li>
                <li><a href="#faq" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">FAQ</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-medium mb-4 text-white">Company</h3>
              <ul className="space-y-2">
                <li><a href="#about" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">About Us</a></li>
                <li><a href="#blog" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Blog</a></li>
                <li><a href="#careers" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Careers</a></li>
                <li><a href="#contact" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Contact</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-medium mb-4 text-white">Legal</h3>
              <ul className="space-y-2">
                <li><a href="#terms" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Terms of Service</a></li>
                <li><a href="#privacy" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Privacy Policy</a></li>
                <li><a href="#cookies" className="text-sm text-brand-blue-300 hover:text-verifyvision-teal transition-colors">Cookie Policy</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-brand-blue-900 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <a href="#twitter" className="text-brand-blue-300 hover:text-verifyvision-teal transition-colors">
                <span className="sr-only">Twitter</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                </svg>
              </a>
              <a href="#facebook" className="text-brand-blue-300 hover:text-verifyvision-teal transition-colors">
                <span className="sr-only">Facebook</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
              </a>
              <a href="#linkedin" className="text-brand-blue-300 hover:text-verifyvision-teal transition-colors">
