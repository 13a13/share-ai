    ...
    <div className="bg-gray-50 p-4 rounded-lg border">
      ...
      {isEditing ? (
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor={`${component.id}-condition-summary`}>
              AI Analysis Summary
              <span className="text-sm text-muted-foreground ml-2">(Generated by AI)</span>
            </Label>
            <Textarea
              ...
              placeholder="AI-generated condition analysis..."
          ...
          <div className="space-y-2">
            <Label htmlFor={`${component.id}-notes`}>
              Inspector Notes
              <span className="text-sm text-muted-foreground ml-2">(Manual additions only)</span>
            </Label>
            <Textarea
              id={`${component.id}-notes`}
              value={component.notes || ''}
              onChange={(e) => handleFieldUpdate("notes", e.target.value)}
              placeholder="Add your manual observations and notes here..."
              className="min-h-[60px]"
            />
          </div>
