...
const CameraModal: React.FC<CameraModalProps> = ({
  ...
  // Enhanced camera components with proper flex layout
  ...
  return (
    <Dialog open={open} onOpenChange={open => !open && onClose()}>
      <DialogContent
        className="fixed left-[50%] top-[50%] z-50 w-[85vw] max-w-3xl h-[80vh] max-h-[700px] translate-x-[-50%] translate-y-[-50%] p-0 gap-0 bg-black text-white border-0 rounded-lg shadow-2xl overflow-hidden duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]"
      >
        {renderCameraComponents()}
      </DialogContent>
    </Dialog>
